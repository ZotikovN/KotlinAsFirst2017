...
fun angleInRadian(grad: Int, min: Int, sec: Int): Double =
        (grad/180.0*PI+min/60.0/180*PI+sec/3600.0/180*PI)
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial+percent/100.00*initial+percent/100.00*(initial+percent/100.00*initial)+percent/100.00*(initial+percent/100.00*initial+percent/100.00*(initial+percent/100.00*initial))
...
fun numberRevert(number: Int): Int =
        ((number/100)+((number/10-(number/100*10))*10)+((number-(number/10*10))*100))aqaqaqaqa
